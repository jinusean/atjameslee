  ...
  <section
    ...
    <div class="colorlib-narrow-content">
      ...
      <div
        ...
        data-animate-effect="fadeInLeft">
        <div class="col-md-12">
          <p class="work-menu"><span><a
            href="#"
            class="active">Graphic Design</a></span> <span><a href="#">Web Design</a></span> <span><a href="#">Software</a></span> <span><a href="#">Apps</a></span></p>
        </div>
      </div>
      <div class="row">
        <div
          ...
          <div
            ...
            <div class="desc">
              <div class="con">
                ...
                <span>Website</span>
                <p class="icon">
                  <span><a href="#"><i class="icon-share3"/></a></span>
                  <span><a href="#"><i class="icon-eye"/> 100</a></span>
                  <span><a href="#"><i class="icon-heart"/> 49</a></span>
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12 animate-box">
          <p><a
            href="#"
            class="btn btn-primary btn-lg btn-load-more">Load more <i class="icon-reload"/></a></p>
        </div>
      </div>
    </div>
  </section>
