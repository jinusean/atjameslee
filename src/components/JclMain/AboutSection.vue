          ...
          <div class="row row-bottom-padded-sm animate-box"
            ...
            <div class="col-md-12">
              <div class="about-desc">
                <span class="heading-meta">Who I am</span>
                ...
                <p>
                  ...
                  "and" and the Little Blind Text should turn around and return
          ...
          <div class="row">
            <div class="col-md-3 animate-box"
              ...
              <div class="services color-1">
                <span class="icon2"><i class="icon-bulb"/></span>
            ...
            <div class="col-md-3 animate-box"
              ...
              <div class="services color-2">
                <span class="icon2"><i class="icon-globe-outline"/></span>
                <h3>Web Design</h3>
              </div>
            </div>
            <div class="col-md-3 animate-box"
              ...
              <div class="services color-3">
                <span class="icon2"><i class="icon-data"/></span>
                <h3>Software</h3>
              </div>
            </div>
            <div class="col-md-3 animate-box"
              ...
              <div class="services color-4">
                <span class="icon2"><i class="icon-phone3"/></span>
                <h3>Application</h3>
              </div>
            </div>
          </div>
