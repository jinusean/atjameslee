          ...
          <div class="timeline-centered">
            ...
            >
              <div class="timeline-entry-inner">
                <div class="timeline-icon color-1"><i class="icon-pen2" /></div>
            ...
            >
              <div class="timeline-entry-inner">
                <div class="timeline-icon color-2"><i class="icon-pen2" /></div>
                <div class="timeline-label">
                  <h2>
            ...
            >
              <div class="timeline-entry-inner">
                <div class="timeline-icon color-3"><i class="icon-pen2" /></div>
                <div class="timeline-label">
            ...
            >
              <div class="timeline-entry-inner">
                <div class="timeline-icon color-4"><i class="icon-pen2" /></div>
                <div class="timeline-label">
                  <h2>
            ...
            >
              <div class="timeline-entry-inner">
                <div class="timeline-icon color-5"><i class="icon-pen2" /></div>
                <div class="timeline-label">
                  <h2>
