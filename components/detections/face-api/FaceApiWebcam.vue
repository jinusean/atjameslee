<template>
  <div class="center-content page-container">
    ...
    >
      <p v-if="!isLoadedMetaData">Loading...</p>
...
export default {
  ...
  computed: {
    videoClass() {
      ...
      return this.isFaceDetected ? 'hidden' : ''
    },
    canvasClass() {
      ...
      return !this.isFaceDetected ? 'hidden' : 'max-w-full h-auto'
    },
    faceDetectionNet() {
      const net = {
  ...
  methods: {
    ...
    async startTracking() {
      ...
      await Promise.all([
        this.faceDetectionNet.load(this.weightsSrc),
        faceApi
          .loadFaceLandmarkModel(this.weightsSrc)
