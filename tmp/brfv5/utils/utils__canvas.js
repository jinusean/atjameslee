...
export const drawTexture = (
  ...
  for (let i = 0; i < l; i += 3) {
    ...
    interpolatePoint(p0, pi, p0, 1.0 + overdraw / distance(p0, pi))
    interpolatePoint(p1, pi, p1, 1.0 + overdraw / distance(p1, pi))
    interpolatePoint(p2, pi, p2, 1.0 + overdraw / distance(p2, pi))
