...
export const configureFaceTracking = (
  ...
  brfv5Config.faceTrackingConfig.numTrackingPasses = numTrackingPasses || 3
  brfv5Config.faceTrackingConfig.enableFreeRotation = enableFreeRotation
  brfv5Config.faceTrackingConfig.maxRotationZReset = !enableFreeRotation
    ? 34.0
    : 999.0
}
...
export const configureCameraInput = (brfv5Config, imageWidth, imageHeight) => {
  ...
  brfv5Config.faceDetectionConfig.regionOfInterest.setTo(
    (imageWidth - roiSize) * 0.5,
    (imageHeight - roiSize) * 0.5,
    roiSize,
    roiSize
  )
  ...
  brfv5Config.faceTrackingConfig.confidenceThresholdStart = 0.8
...
export const deepCopyBRFv5Config = (src, dst) => {
  ...
  dst.faceDetectionConfig.regionOfInterest.x =
    src.faceDetectionConfig.regionOfInterest.x
  dst.faceDetectionConfig.regionOfInterest.y =
    src.faceDetectionConfig.regionOfInterest.y
  dst.faceDetectionConfig.regionOfInterest.width =
    src.faceDetectionConfig.regionOfInterest.width
  dst.faceDetectionConfig.regionOfInterest.height =
    src.faceDetectionConfig.regionOfInterest.height
  ...
  dst.faceDetectionConfig.faceSizeIncrease =
    src.faceDetectionConfig.faceSizeIncrease

  dst.faceDetectionConfig.stepSize = src.faceDetectionConfig.stepSize
  dst.faceDetectionConfig.minNumNeighbors =
    src.faceDetectionConfig.minNumNeighbors

  dst.faceDetectionConfig.rectMergeFactor =
    src.faceDetectionConfig.rectMergeFactor
  dst.faceDetectionConfig.rectSkipFactor =
    src.faceDetectionConfig.rectSkipFactor
  dst.faceDetectionConfig.filterNoise = src.faceDetectionConfig.filterNoise

  dst.faceTrackingConfig.regionOfInterest.x =
    src.faceTrackingConfig.regionOfInterest.x
  dst.faceTrackingConfig.regionOfInterest.y =
    src.faceTrackingConfig.regionOfInterest.y
  dst.faceTrackingConfig.regionOfInterest.width =
    src.faceTrackingConfig.regionOfInterest.width
  dst.faceTrackingConfig.regionOfInterest.height =
    src.faceTrackingConfig.regionOfInterest.height

  dst.faceTrackingConfig.numFacesToTrack =
    src.faceTrackingConfig.numFacesToTrack
  dst.faceTrackingConfig.numTrackingPasses =
    src.faceTrackingConfig.numTrackingPasses

  dst.faceTrackingConfig.minFaceScaleStart =
    src.faceTrackingConfig.minFaceScaleStart
  dst.faceTrackingConfig.maxFaceScaleStart =
    src.faceTrackingConfig.maxFaceScaleStart
  dst.faceTrackingConfig.maxRotationXStart =
    src.faceTrackingConfig.maxRotationXStart
  dst.faceTrackingConfig.maxRotationYStart =
    src.faceTrackingConfig.maxRotationYStart
  dst.faceTrackingConfig.maxRotationZStart =
    src.faceTrackingConfig.maxRotationZStart
  dst.faceTrackingConfig.confidenceThresholdStart =
    src.faceTrackingConfig.confidenceThresholdStart

  dst.faceTrackingConfig.minFaceScaleReset =
    src.faceTrackingConfig.minFaceScaleReset
  dst.faceTrackingConfig.maxFaceScaleReset =
    src.faceTrackingConfig.maxFaceScaleReset
  dst.faceTrackingConfig.maxRotationXReset =
    src.faceTrackingConfig.maxRotationXReset
  dst.faceTrackingConfig.maxRotationYReset =
    src.faceTrackingConfig.maxRotationYReset
  dst.faceTrackingConfig.maxRotationZReset =
    src.faceTrackingConfig.maxRotationZReset
  dst.faceTrackingConfig.confidenceThresholdReset =
    src.faceTrackingConfig.confidenceThresholdReset

  dst.faceTrackingConfig.enableStabilizer =
    src.faceTrackingConfig.enableStabilizer
  dst.faceTrackingConfig.enableFreeRotation =
    src.faceTrackingConfig.enableFreeRotation
