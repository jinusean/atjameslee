...
export const enableDynamicPerformance = (brfv5Manager, brfv5Config) => {
  ...
  configureFaceTracking(
    _brfv5Config,
    startParams.numTrackingPasses,
    startParams.enableFreeRotation
  )
...
export const startParams = {
  numTrackingPasses: _numTrackingPasses,
  enableFreeRotation: _enableFreeRotation,
}
